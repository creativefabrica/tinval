...
func (_mock *MockValidationClient) Validate(ctx context.Context, id tinval.TIN) error {
	...
	var r0 error
	if returnFunc, ok := ret.Get(0).(func(context.Context, tinval.TIN) error); ok {
...
func (_c *MockValidationClient_Validate_Call) Run(run func(ctx context.Context, id tinval.TIN)) *MockValidationClient_Validate_Call {
	_c.Call.Run(func(args mock.Arguments) {
		run(args[0].(context.Context), args[1].(tinval.TIN))
	})
	return _c
}
...
func (_c *MockValidationClient_Validate_Call) RunAndReturn(run func(ctx context.Context, id tinval.TIN) error) *MockValidationClient_Validate_Call {
	_c.Call.Return(run)
	return _c
}
